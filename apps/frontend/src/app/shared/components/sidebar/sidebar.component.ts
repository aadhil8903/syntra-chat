...
@Component({
  ...
  template: `
    ...
    <aside
      ...
      class="hidden md:flex relative border-r border-[#27272a] bg-[#0d0d10] flex-col justify-between p-3 h-full flex-shrink-0 select-none transition-[width] duration-75"
    >
      <div class="space-y-4">
        ...
        <div class="flex items-center" [ngClass]="isCollapsed ? 'justify-center' : 'justify-between px-2'">
          ...
          <button
            ...
            class="min-w-[36px] min-h-[36px] p-1.5 rounded-lg text-[#a1a1aa] hover:text-white hover:bg-[#1f1f23] transition-colors flex items-center justify-center"
    ...
    <div class="md:hidden">
      ...
      <div
        class="fixed inset-y-0 left-0 z-50 w-72 max-w-[85vw] bg-[#0d0d10] border-r border-[#27272a] shadow-2xl flex flex-col justify-between p-4 transform transition-transform duration-200 ease-out"
      ...
      >
        <div class="space-y-4">
          ...
          <div class="flex items-center justify-between pb-3 border-b border-[#27272a]">
            ...
            <button
              ...
              class="min-w-[44px] min-h-[44px] rounded-xl text-zinc-400 hover:text-white hover:bg-[#18181b] flex items-center justify-center transition-colors"
            >
        ...
        @if (user(); as u) {
          <div class="pt-3 border-t border-[#27272a] space-y-3">
            <div class="flex items-center gap-3 px-1">
              <div class="w-10 h-10 rounded-full bg-[#18181b] border border-[#3f3f46] flex items-center justify-center text-sm font-semibold text-white flex-shrink-0">
                {{ u.firstName.charAt(0) }}{{ u.lastName.charAt(0) }}
              </div>
              <div class="truncate flex-1 min-w-0">
                <div class="text-sm font-medium text-white truncate">{{ u.firstName }} {{ u.lastName }}</div>
                <div class="text-xs text-[#71717a] truncate font-mono">{{ u.email }}</div>
              </div>
            </div>
            ...
            <button
              (click)="logout()"
              type="button"
              class="w-full min-h-[44px] px-3.5 rounded-xl text-zinc-300 hover:text-white bg-[#18181b] hover:bg-[#1f1f23] border border-[#27272a] text-xs font-semibold flex items-center justify-center gap-2 transition-colors"
            >
