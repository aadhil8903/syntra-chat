            ...
            <div>
              ...
              <div class="relative">
                <input
                  ...
                  class="w-full pl-3 pr-10 py-2.5 rounded-xl bg-[#18181b] border border-[#27272a] text-white focus:outline-none focus:border-white placeholder:text-zinc-600 font-mono"
                />
                <button
                  type="button"
